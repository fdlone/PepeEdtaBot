...
class GenRecord:
    ...
    # M3R-145/230: the walk's start source of the winner as the generator
    # traced it; the l1_hot_channel gate's coverage reads it (a hot-route seed
    # anchors a walk only when it opens a stored start).
