...
5d. **Бонус различности** (M3R-100, `selection_diversity_bonus`, дефолт 0 —
   ...
   (дефолт 0) — для ответов с контекстом, `selection_diversity_bonus_noctx`
...
5f. **Фразовый маршрут** (M3R-210, `phrase_slot_ratio`, дефолт 0 —
   выключено; с 2026-09-11): после assoc и до цикла п.3 кладётся до
