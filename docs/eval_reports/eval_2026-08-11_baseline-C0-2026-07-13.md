# Eval report 2026-08-11 snapshot=baseline-C0-2026-07-13 prompts=308b7deaea0f seeds=42,1337,2026

Revision: `c8ee338`. Generations per configuration: 500.
...
C0: distinct-2 = 0.649 (basis 14733), distinct-3 = 0.805 (basis 13234) — type/token ratios, comparable only at equal basis; latency p50/p95 = 23.7/38.8 ms; cache_hit_rate: insufficient data (no cache instrumentation before Phase 1); storage_delta: n/a.

CF: distinct-2 = 0.649 (basis 14733), distinct-3 = 0.805 (basis 13234) — type/token ratios, comparable only at equal basis; latency p50/p95 = 23.7/38.8 ms; cache_hit_rate: insufficient data (no cache instrumentation before Phase 1); storage_delta: n/a.
...
- **phase7_order4**: insufficient data — shadow order selector lands in Phase 1; no shadow data yet
- **performance.generation_p95**: pass — C0 p95 = 38.8 ms (budget 150 ms)
