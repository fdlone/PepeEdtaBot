# Eval report 2026-09-02 snapshot=assoc-pilot prompts=bababb4b7693 seeds=42,1337,2026 mode=ctx
...
C0: distinct-2 = 0.661 (basis 14875), distinct-3 = 0.818 (basis 13376) — type/token ratios, comparable only at equal basis; их дельта считается НЕпарным бутстрапом (`distinct_delta_ci`), в отличие от таблицы метрик — интервал шире истинного, вердикт консервативен; latency p50/p95 = 22.7/36.3 ms; cache_hit_rate: 41%; mean normalized entropy: 0.242 (branching 3.46); mean applied temperature: 2.77; temporal blend: coverage 0.0%, shift 0.0000; order interpolation: coverage 0.0%, shift 0.0000; shadow order-4 share: 0.0% (estimator=window); hot-ngram seeds: no draws; storage_delta: n/a.

C10a20: distinct-2 = 0.652 (basis 14708), distinct-3 = 0.812 (basis 13208) — type/token ratios, comparable only at equal basis; их дельта считается НЕпарным бутстрапом (`distinct_delta_ci`), в отличие от таблицы метрик — интервал шире истинного, вердикт консервативен; latency p50/p95 = 23.5/36.7 ms; cache_hit_rate: 40%; mean normalized entropy: 0.245 (branching 3.47); mean applied temperature: 2.73; temporal blend: coverage 0.0%, shift 0.0000; order interpolation: coverage 0.0%, shift 0.0000; shadow order-4 share: 0.0% (estimator=window); hot-ngram seeds: no draws; storage_delta: n/a.

C10a40: distinct-2 = 0.660 (basis 15029), distinct-3 = 0.815 (basis 13529) — type/token ratios, comparable only at equal basis; их дельта считается НЕпарным бутстрапом (`distinct_delta_ci`), в отличие от таблицы метрик — интервал шире истинного, вердикт консервативен; latency p50/p95 = 21.5/33.6 ms; cache_hit_rate: 40%; mean normalized entropy: 0.245 (branching 3.53); mean applied temperature: 2.70; temporal blend: coverage 0.0%, shift 0.0000; order interpolation: coverage 0.0%, shift 0.0000; shadow order-4 share: 0.0% (estimator=window); hot-ngram seeds: no draws; storage_delta: n/a.
...
| C10a20 | generic | 375 | 1.000 [1.000, 1.000] | 0.221 [0.181, 0.264] | 0.003 [0.000, 0.008] | 0.361 [0.330, 0.388] |
| C10a20 | meme-bait | 375 | 1.000 [1.000, 1.000] | 0.264 [0.224, 0.312] | 0.000 [0.000, 0.000] | 0.373 [0.344, 0.403] |
| C10a20 | short-degenerate | 375 | 1.000 [1.000, 1.000] | 0.008 [0.000, 0.019] | 0.000 [0.000, 0.000] | 0.263 [0.222, 0.303] |
| C10a20 | topical | 375 | 1.000 [1.000, 1.000] | 0.320 [0.275, 0.365] | 0.000 [0.000, 0.000] | 0.277 [0.251, 0.305] |
| C10a40 | generic | 375 | 1.000 [1.000, 1.000] | 0.197 [0.157, 0.235] | 0.003 [0.000, 0.008] | 0.330 [0.301, 0.360] |
| C10a40 | meme-bait | 375 | 1.000 [1.000, 1.000] | 0.259 [0.216, 0.301] | 0.003 [0.000, 0.008] | 0.342 [0.315, 0.371] |
| C10a40 | short-degenerate | 375 | 1.000 [1.000, 1.000] | 0.005 [0.000, 0.013] | 0.000 [0.000, 0.000] | 0.258 [0.218, 0.299] |
| C10a40 | topical | 375 | 1.000 [1.000, 1.000] | 0.323 [0.275, 0.371] | 0.003 [0.000, 0.008] | 0.264 [0.239, 0.291] |
...
|---|---|---|---|---|---|---|---|---|---|
| C0 | vanilla | 1500 | 0.651 [0.639, 0.662] | 0.991 [0.985, 0.995] | 0.711 [0.687, 0.734] | 0.300 [0.277, 0.323] | 0.280 [0.256, 0.307] | 23.6 / 44.5 | 0 |
| C0 | seeded | 0 | not attempted | — | — | — | — | — | — | — |
| C0 | mutated | 1500 | 0.097 [0.091, 0.103] | 0.444 [0.421, 0.469] | 0.227 [0.195, 0.261] | 0.190 [0.140, 0.244] | 0.219 [0.152, 0.285] | 21.8 / 25.5 | 0 |
| C0 | extension | 1500 | 0.252 [0.241, 0.263] | 0.743 [0.721, 0.765] | 0.263 [0.239, 0.290] | 0.151 [0.120, 0.184] | 0.034 [0.017, 0.055] | 25.3 / 19.6 | 0 |
| C0 | hot | 0 | not attempted | — | — | — | — | — | — | — |
| C0 | assoc | 0 | not attempted | — | — | — | — | — | — | — |
| C10a20 | vanilla | 1500 | 0.564 [0.553, 0.573] | 0.991 [0.985, 0.995] | 0.692 [0.670, 0.715] | 0.310 [0.289, 0.332] | 0.261 [0.236, 0.289] | 24.4 / 31.0 | 0 |
| C10a20 | seeded | 0 | not attempted | — | — | — | — | — | — | — |
| C10a20 | mutated | 1500 | 0.077 [0.072, 0.083] | 0.360 [0.335, 0.385] | 0.222 [0.185, 0.259] | 0.198 [0.143, 0.262] | 0.225 [0.150, 0.300] | 21.7 / 26.1 | 0 |
| C10a20 | extension | 1500 | 0.215 [0.205, 0.225] | 0.696 [0.673, 0.719] | 0.233 [0.209, 0.259] | 0.137 [0.108, 0.171] | 0.037 [0.016, 0.066] | 26.3 / 20.3 | 0 |
| C10a20 | hot | 0 | not attempted | — | — | — | — | — | — | — |
| C10a20 | assoc | 1500 | 0.144 [0.140, 0.149] | 0.722 [0.699, 0.747] | 0.100 [0.082, 0.117] | 0.224 [0.171, 0.279] | 0.000 [0.000, 0.000] | 24.7 / 24.0 | F4_stale 17 |
| C10a40 | vanilla | 1500 | 0.484 [0.473, 0.494] | 0.969 [0.960, 0.978] | 0.653 [0.625, 0.676] | 0.293 [0.269, 0.316] | 0.287 [0.258, 0.316] | 22.4 / 25.9 | 0 |
| C10a40 | seeded | 0 | not attempted | — | — | — | — | — | — | — |
| C10a40 | mutated | 1500 | 0.064 [0.059, 0.069] | 0.305 [0.283, 0.329] | 0.231 [0.194, 0.273] | 0.180 [0.122, 0.241] | 0.170 [0.104, 0.245] | 19.2 / 23.9 | 0 |
| C10a40 | extension | 1500 | 0.186 [0.177, 0.196] | 0.631 [0.605, 0.657] | 0.248 [0.223, 0.275] | 0.131 [0.102, 0.162] | 0.013 [0.000, 0.030] | 24.2 / 19.6 | 0 |
| C10a40 | hot | 0 | not attempted | — | — | — | — | — | — | — |
| C10a40 | assoc | 1500 | 0.266 [0.257, 0.275] | 0.731 [0.708, 0.756] | 0.191 [0.169, 0.213] | 0.199 [0.164, 0.236] | 0.005 [0.000, 0.014] | 22.0 / 23.8 | F4_stale 29 |

## Gates

- **phase2_entropy[C10a20]**: fail — copy Δ -0.023 [-0.043, -0.001] *; distinct-2 Δ -0.009 [-0.023, 0.016]; distinct-3 Δ -0.006 [-0.026, 0.021]; affinity_without_copy Δ 0.008 [-0.009, 0.026]; p95 36.7 ms (budget 150) — distinct-2 did not rise significantly; distinct-3 did not rise significantly
- **phase2_entropy[C10a40]**: fail — copy Δ -0.030 [-0.050, -0.010] *; distinct-2 Δ -0.000 [-0.018, 0.020]; distinct-3 Δ -0.003 [-0.025, 0.023]; affinity_without_copy Δ -0.011 [-0.028, 0.007]; p95 33.6 ms (budget 150) — distinct-2 did not rise significantly; distinct-3 did not rise significantly
...
- **assoc_pilot[C10a20]**: insufficient data — Q1 builds: assoc present in 72.2% of pools (draws 1500, empty 27%; floor 10%); Q2 pool ECB Δ 0.103 [0.068, 0.139] *; window escape Δ -0.031 [-0.086, 0.027]; p95 36.7 ms (budget 150); Q4 affinity_without_copy Δ 0.008 [-0.009, 0.026]; copy Δ -0.023 [-0.043, -0.001] *; repetition Δ -0.001 [-0.004, 0.001]; gate requires both context modes, this run measured ctx only (noctx not measured)
- **assoc_pilot[C10a40]**: insufficient data — Q1 builds: assoc present in 73.1% of pools (draws 1500, empty 27%; floor 10%); Q2 pool ECB Δ 0.179 [0.144, 0.213] *; window escape Δ 0.015 [-0.043, 0.073]; p95 33.6 ms (budget 150); Q4 affinity_without_copy Δ -0.011 [-0.028, 0.007]; copy Δ -0.030 [-0.050, -0.010] *; repetition Δ 0.000 [-0.003, 0.003]; gate requires both context modes, this run measured ctx only (noctx not measured)
...
- **meme_regression[C10a20]**: pass — 17/18 memes reproduced (94%); C0 17/18 (94%), tolerance 10%; prompt set bababb4b7693
- **meme_regression[C10a40]**: pass — 16/18 memes reproduced (89%); C0 17/18 (94%), tolerance 10%; prompt set bababb4b7693
