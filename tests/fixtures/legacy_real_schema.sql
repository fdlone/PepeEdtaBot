...
INSERT INTO messages(chat_id, author_id, text) VALUES
    (-1003736119498, 396273827, 'привет всем'),
    (-1003736119498, 249369775, 'как дела'),
    (-1003736119498, 396273827, 'всё хорошо'),
    (-1003736119498, 249369775, 'пойдём пить кофе'),
    (-1001147461458, 111222333, 'другой чат тоже здесь');

-- Данные Маркова n=2
INSERT INTO starts(chat_id, w1, w2, cnt) VALUES
    (-1003736119498, 'привет',  'всем',   1),
    (-1003736119498, 'как',     'дела',   1),
    (-1003736119498, 'всё',     'хорошо', 1),
    (-1003736119498, 'пойдём',  'пить',   1);

INSERT INTO transitions(chat_id, w1, w2, w3, cnt) VALUES
    (-1003736119498, 'пойдём', 'пить', 'кофе', 1),
    (-1003736119498, 'привет', 'всем', 'как',  1);
...
INSERT INTO transitions3(chat_id, w1, w2, w3, w4, cnt) VALUES
    (-1003736119498, 'а', 'пойдём', 'пить', 'кофе', 1);

-- Данные Маркова n=1
INSERT INTO transitions1(chat_id, w1, w2, cnt) VALUES
    (-1003736119498, 'пойдём', 'пить',   1),
    (-1003736119498, 'пить',   'кофе',   1),
    (-1003736119498, 'привет', 'всем',   1),
    (-1003736119498, 'всем',   'как',    1),
    (-1003736119498, 'как',    'дела',   1);
