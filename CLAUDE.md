...
| Суточный пасс читает настройки чата-триггера и применяет их **ко всем** чатам | `app/services/reply_pipeline.py:637`; map §3.9 |
...
| Новый хвостовой слой ответа обязан обновить `normalize_reply_for_repeat`, иначе анти-повтор не узнаёт отправленную форму | `app/core/response_generator.py:190`; map §4 |
