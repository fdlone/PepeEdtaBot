...
- Гейт, объявивший `requires_both_modes`, снимается в **двух режимах** `ctx` и
  ...
  `phase9_interp` и `structural_escape`; у `phase5_promotion` его нет —
  решение о добавлении за владельцем (пороги пре-регистрированы).
