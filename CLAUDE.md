...
| Новый хвостовой слой ответа обязан обновить `normalize_reply_for_repeat`, иначе анти-повтор не узнаёт отправленную форму | `app/core/response_generator.py:215`; map §4 |
