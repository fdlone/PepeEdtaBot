...
дописка такого кандидата SHALL сохранять маршрут `hot`. С той же даты
перечисление SHALL включать `assoc` — кандидата, собранного вокруг ассоциата
якоря входа (пилот M3R-200); пара счётчиков «розыгрыш ассоциатов / пусто»
SHALL быть видна в снимке телеметрии и в `/stats`, чтобы маршрут, выключенный
данными, был отличим от выключенного ручкой. С 2026-09-11 перечисление SHALL
включать `phrase` — кандидата, собранного вокруг фразы кумулятивного индекса,
вставленной как единица (M3R-210); пара счётчиков «розыгрыш фраз / пусто»
SHALL быть видна там же и по тому же правилу.
...
#### Scenario: Associative route counted with its denominators

- **WHEN** ассоциативный маршрут запускался в генерации
- **THEN** `assoc` засчитан как attempted, как present при наличии кандидата в пуле и как won при его победе, а розыгрыш ассоциатов — с признаком «пусто»

#### Scenario: Phrase route counted with its denominators

- **WHEN** фразовый маршрут запускался в генерации
- **THEN** `phrase` засчитан как attempted, как present при наличии кандидата в пуле и как won при его победе, а розыгрыш фраз — с признаком «пусто»
